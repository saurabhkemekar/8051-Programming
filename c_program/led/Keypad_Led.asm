...
;------------------------------------------------------------
	G$main$0$0 ==.
	C$Keypad_Led.c$2$0_0$1 ==.
;	Keypad_Led.c:2: void main()
;	-----------------------------------------
;	 function main
;	-----------------------------------------
_main:
	...
	ar1 = 0x01
	ar0 = 0x00
	C$Keypad_Led.c$4$1_0$1 ==.
;	Keypad_Led.c:4: while(1)
00102$:
	C$Keypad_Led.c$6$2_0$2 ==.
;	Keypad_Led.c:6: P1=P2;
	mov	_P1,_P2
	sjmp	00102$
	C$Keypad_Led.c$8$1_0$1 ==.
;	Keypad_Led.c:8: }
	C$Keypad_Led.c$8$1_0$1 ==.
	XG$main$0$0 ==.
	ret
